...
// querySelectorAll -> []
const linesSections = document.querySelectorAll('.sect .line');

linesSections.forEach(line=>line.addEventListener('click', function(){
    this.parentElement.dataset.open = this.parentElement.dataset.open==="true"?false:true;
}))
